...
exports.FRating = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const react_1 = require("react");
const react_native_1 = require("react-native");
const react_native_svg_1 = require("react-native-svg");
const FRating = ({ style = {}, fillColor = "#faad1e", size = 16, strokeColor = "#878792", ...props }) => {
    const [value, setValue] = (0, react_1.useState)(0);
    (0, react_1.useEffect)(() => {
        if (value !== props.value)
            setValue(props.value ?? 0);
    }, [props.value]);
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: [{ gap: 4, flexDirection: 'row' }, style], children: Array.from({ length: 5 }).map((_, i) => {
            ...
            return ((0, jsx_runtime_1.jsx)(react_native_1.TouchableOpacity, { onPress: props.onChange
                 ...
                 </svg>`, width: size, height: size }) }, 'star-' + i));
        }) }));
};
